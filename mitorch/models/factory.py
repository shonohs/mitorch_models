...
class ModelFactory:
    PREDEFINED_MODELS = {
        ...
        'MobileNetV2-SSDLite': lambda num_classes: SSDLite(SSDLiteExtraLayers3(MobileNetV2()), num_classes),
        'MobileNetV2-Sigmoid-SSDLite': lambda num_classes: SSDLite(SSDLiteExtraLayers3(MobileNetV2()), num_classes, use_sigmoid=True),
        'MobileNetV3-SSDLite': lambda num_classes: SSDLite(SSDLiteExtraLayers3(MobileNetV3()), num_classes),
        'MobileNetV3Small-SSDLite': lambda num_classes: SSDLite(SSDLiteExtraLayers3(MobileNetV3Small()), num_classes),
